...
def main():
    ...
    parser.add_argument("--act-group-efficient-accumulation", default=False, action="store_true", help="efficient accumulation for groupwise activation quantization")
    ...
    parser.add_argument("--eval-ppl-dataset", type=str, nargs='+', default=['wikitext2'], help="dataset for ppl evaluation")
