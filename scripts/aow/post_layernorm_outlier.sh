...
# This script is tailored for running on 6 V100 GPUs
...
--epoch 0 --output_dir ./log/llama-13b-aow \
--quant-method aowquant \
--multigpu \
--wbits 4 --abits 4 &
...
--model  $MODEL_DIR/llama-13b-hf-transformers-4.29 --eval_ppl \
--epoch 0 --output_dir ./log/llama-13b-aow-qkv \
--quant-method aowquant \
--wbits 4 --abits 4 \
--multigpu \
--aow-quant-act-qkv &
...
--model  $MODEL_DIR/llama-13b-hf-transformers-4.29 --eval_ppl \
--epoch 0 --output_dir ./log/llama-13b-aow-fc1 \
--quant-method aowquant \
--wbits 4 --abits 4 \
--multigpu \
--aow-quant-act-fc1 &
