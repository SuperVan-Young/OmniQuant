...
CUDA_VISIBLE_DEVICES="2" python autogptq.py --group_size 128 --model llama-13b-meta &
CUDA_VISIBLE_DEVICES="3" python autogptq.py --group_size 128 --model opt-13b &
CUDA_VISIBLE_DEVICES="4" python autogptq.py --group_size 128 --model llama-30b-meta &
CUDA_VISIBLE_DEVICES="5" python autogptq.py --group_size 128 --model opt-30b &
CUDA_VISIBLE_DEVICES="0" python autogptq.py --group_size 128 --model llama-65b-meta &
CUDA_VISIBLE_DEVICES="1" python autogptq.py --group_size 128 --model opt-66b &